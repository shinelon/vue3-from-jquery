...
你习惯了 `<script src="cdn/xxx.js">` 引库；现代前端几乎全靠 **npm**。这篇把 npm 讲到「够用且讲透」——**为什么需要它、怎么装好、最常用的几条命令、以及中国网络下的镜像与排错**。读完就能无障碍跟完 [主教程（Vue3）](../../vue3/docs/00-序言.md) 和 [Vite 教程](../../vite/docs/00-为什么是Vite.md)。
...
> 🎉 搞定 npm，你就能顺畅地跟 [Vue3 主教程第 4 章](../../vue3/docs/04-从CDN到Vite.md) 和 [Vite 教程](../../vite/docs/00-为什么是Vite.md) 了。
